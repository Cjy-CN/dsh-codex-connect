window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function validProxyFields(address, port) {
			if (!((address?.trim().length ?? 0) > 0)) return port === void 0;
			const portValid = port !== void 0 && Number.isInteger(port) && port >= 1 && port <= 65535;
		...
		function OpenAICodexConfiguration({ scope, t }) {
			...
			const validContextWindow = draft !== void 0 && (draft.contextWindow === void 0 || Number.isSafeInteger(draft.contextWindow) && draft.contextWindow >= 1);
			const validProxy = draft !== void 0 && validProxyFields(draft.proxyAddress, draft.proxyPort);
			...
			const save = async () => {
				...
				try {
					for (const field of CONFIG_FIELDS) {
						...
						if (scope.getSnapshot().value?.[field] === target) continue;
						if (target === void 0) {
							const before = scope.getSnapshot();
							await scope.unset(field);
							const after = scope.getSnapshot().value;
							const baseValue = isRecord(before.base) ? before.base[field] : void 0;
							if (after?.[field] !== void 0 && after?.[field] !== baseValue) throw new Error(`Host refused clearing ${field}`);
						} else {
							await scope.set(field, target);
							if (scope.getSnapshot().value?.[field] !== target) throw new Error(`Host refused ${field}`);
						}
					}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					draft === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							flexDirection: "column",
							gap: 13
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
							style: headingStyle,
							children: t("contextWindowHeading")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: {
								...bodyStyle$1,
								marginTop: 4
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									step: 1,
									value: draft.contextWindow === void 0 ? "" : draft.contextWindow,
									disabled: !editable,
									placeholder: t("contextWindowPlaceholder"),
									"aria-invalid": !validContextWindow,
									onChange: (event) => {
										const value = event.currentTarget.valueAsNumber;
										update("contextWindow", Number.isNaN(value) ? void 0 : value);
									}
								})]
							})
						})]
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									onChange: (event) => {
										update("proxyAddress", event.currentTarget.value);
									}
								})]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								style: formFieldStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									max: 65535,
									step: 1,
									value: draft.proxyPort === void 0 ? "" : draft.proxyPort,
									disabled: !editable,
									"aria-invalid": !validProxy,
									onChange: (event) => {
										const value = event.currentTarget.valueAsNumber;
										update("proxyPort", Number.isNaN(value) ? void 0 : value);
									}
								})]
							})]
						})]
		...
		async function jsonRequest(path, method = "GET", signal, headers = {}) {
		...
		function OpenAICodexSettings({ t, configScope, embedded = false }) {
			...
			const importCodexAuth = async () => {
				...
				const attempt = async (overwrite) => {
					return jsonRequest(OPENAI_CODEX_AUTH_IMPORT_PATH, "POST", void 0, overwrite ? { [OPENAI_CODEX_IMPORT_OVERWRITE_HEADER]: "confirm" } : {});
				};
				try {
					let result;
					try {
					...
					if (mounted.current) setImportNotice({
						kind: "error",
						message: importErrorMessage(error, t)
					});
				} finally {
					if (mounted.current) {
						setImporting(false);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [embedded ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
					...
					children: [
						...
						status.status === "loading" || status.status === "remote-web-origin-not-trusted" ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: importStyle,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
									style: quotaTitleStyle,
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										children: importing ? t("importWorking") : t("importButton")
									})
								}),
								importNotice === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									role: "status",
									style: importNotice.kind === "success" ? successStyle : errorStyle,
