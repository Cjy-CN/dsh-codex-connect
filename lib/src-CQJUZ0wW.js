...
var OpenAICodexWebAuth = class {
	...
	async status() {
		...
		return stored.authenticated ? {
			status: "signed-in",
			...stored.expiresAt === void 0 ? {} : { expiresAt: stored.expiresAt.toISOString() }
		} : { status: "signed-out" };
	}
...
//#endregion
export { OpenAICodexCredentialStore as C, OPENAI_CODEX_PROVIDER as S, VIEW_IMAGE_TOOL_NAME as _, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as a, openAICodexAuthStatus as b, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as c, OPENAI_CODEX_SEARCH_URL as d, OpenAICodexSearchProvider as f, recordOpenAICodexSearchRequest as g, installOpenAICodexSearchEvent as h, name as i, OPENAI_CODEX_BASE_URL as l, OPENAI_CODEX_SEARCH_MODEL_REQUEST_EVENT as m, apply as n, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as o, mapOpenAICodexSearchResponse as p, inject as r, DEFAULT_OPENAI_CODEX_SEARCH_MODE as s, Config as t, OPENAI_CODEX_SEARCH_PROVIDER as u, loginOpenAICodex as v, openAICodexAuthPath as w, OPENAI_CODEX_AUTH_FILENAME as x, logoutOpenAICodex as y };
